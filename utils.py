...
def get_common_path(hyper_params):
    ret = "{}_user_support_{}_{}_gumbel_samples_{}_gumbel_tau_{}_cardinality_reg".format(
        hyper_params['dataset'], hyper_params['user_support'], hyper_params['num_per_user'],
        hyper_params['gumbel_tau'], hyper_params['cardinality_reg']
    )
    
    ret += "_depth_{}_lr_{}_bsz_{}_accum_{}_seed_{}".format(
        hyper_params['depth'], hyper_params['learning_rate'], 
        hyper_params['batch_size'], hyper_params['accumulate_steps'],
        hyper_params['seed']
    )
